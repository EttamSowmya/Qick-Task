...
void main() async {
  ...
  final keyApplicationId = 'ZkbfYatGuFe7ViF4MVB3d5umURhMkTwBIv49UAUU';
  final keyClientKey = '4MIJcBdY6rmUcNUWfovDRKtyZxt5E4v15RdlY5IY';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(168, 146, 231, 244))
       ),
